...
class RaitingForm(FlaskForm):
  ...
  level= StringField("Level of officiating", validators=[InputRequired("This field is required"), DataRequired("No empty tricks!"), Length(min=1, max=50, message="Level should be 2 to 50 characters long")])
  pc = FloatField("Play calling")
  mec = FloatField("Mechanics")
  gm = FloatField("Game Management")
  com = FloatField("Communication")
  aty = FloatField("Atypical Situations")
  gen = FloatField("General Appearence")
